      ...
      <div className="container-wide px-4 sm:px-6 lg:px-8 relative z-10 w-full my-auto">
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-8 items-center [direction:ltr]">
          ...
          >
            ...
            >
              ...
              >
                ...
                <br />
                <span className="text-gradient-accent">{t('hero.lastName')}</span>
              </motion.h1>
              ...
              >
                <MagneticButton asChild size="lg" className="rounded-full px-5 py-2.5 text-sm sm:px-7 sm:py-3 sm:text-base">
                  <a href="#projects" className="flex items-center gap-2">
                    {t('hero.viewWork')} <span className="text-sm rtl:rotate-180">→</span>
                  </a>
                </MagneticButton>
                <MagneticButton
                  variant="outline"
                  ...
                  asChild
                >
                  <a href={cvFile} download={cvFileName} className="flex items-center gap-2">
          ...
          <div className="lg:col-span-5 relative flex items-center justify-center min-h-[420px] sm:min-h-[500px]">
            {/* Parallax Container */}
            <motion.div
              style={{ x: Math.round(x * 1.2), y: Math.round(y * 1.2) }}
            ...
            >
              ...
              <motion.div
                ...
                className={`absolute inset-0 rounded-full border border-dashed transition-all duration-700 ${
                  isDark ? "border-accent/10 opacity-30" : "border-accent/5 opacity-20"
                }`}
              />
        ...
        {/* Stats Section Wrapped inside Hero Bottom */}
        <motion.div
